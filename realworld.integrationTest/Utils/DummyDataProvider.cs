        ...
        public IEnumerable<Article> GetDummyArticles() {
            return new List<Article>() {
                new Article(title: "How to train your dragon", body: "It takes a Jacobian", description: "Ever wonder how?") {
                    ...
                    //use fixed value to avoid error
                    CreatedAt = new DateTime(day: 18, month: 8, year: 2002, hour: 20, minute: 18, second: 20, kind: DateTimeKind.Utc),
                    UpdatedAt = new DateTime(day: 18, month: 8, year: 2002, hour: 20, minute: 18, second: 20, kind: DateTimeKind.Utc),
                },
