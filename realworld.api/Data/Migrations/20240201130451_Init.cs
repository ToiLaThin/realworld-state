    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserFollower", x => new { x.UserName, x.FollowerName });
                    table.ForeignKey(
                        name: "FK_UserFollower_Users_FollowerName",
                        column: x => x.FollowerName,
                        principalTable: "Users",
                        principalColumn: "Username",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserFollower_Users_UserName",
                        column: x => x.UserName,
                        principalTable: "Users",
                        principalColumn: "Username",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ArticleFavoriteLinks", x => new { x.ArticleId, x.Username });
                    table.ForeignKey(
                        name: "FK_ArticleFavoriteLinks_Articles_ArticleId",
                        column: x => x.ArticleId,
                        principalTable: "Articles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ArticleFavoriteLinks_Users_Username",
                        column: x => x.Username,
                        principalTable: "Users",
                        principalColumn: "Username",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ArticleFavoriteLinks_Username",
                table: "ArticleFavoriteLinks",
                column: "Username");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserFollower_FollowerName",
                table: "UserFollower",
                column: "FollowerName");
