...
import { articleFeatureKey, articleReducer } from './state/article/article.reducers'
import { ArticleEffect } from './state/article/article.effects'
...
@NgModule({
  ...
  imports: [
    ...
    EffectsModule.forRoot([HomeEffects, AuthEffect, ProfileEffect, ArticleEffect]),
  ],
  providers: [],
